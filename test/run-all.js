...
const tests = [
  ...
  'test-book-guide-validation.js',
  'test-book-guide-provider.js',
  ...
  'test-calibre-routes.js',
  'test-calibre-plugin-package.js',
  'test-calibre-ui.js',
  'test-book-guide-evaluation.js',
  'test-book-guide-ui.js',
  'test-download-background.js',
  'test-import-job-sse.js',
  'test-offline-audio-package.js',
  'test-offline-ready-packages.js',
  'test-offline-package-recovery.js',
  'test-offline-retained-integration.js',
  'test-offline-retry-owner.js',
  'test-offline-readiness-notifications.js',
  'test-offline-preparation-coordinator.js',
  'test-offline-transfer-manifest.js',
  'test-offline-window-preparation.js',
  'test-offline-source-provenance.js',
  'test-offline-block-transfer.js',
  'test-offline-block-store.js',
  'test-offline-device-coordinator.js',
  ...
  'test-chapter-transition-state.js',
  'test-chapter-audio-reconcile.js',
  'test-chapter-rebuild.js',
  'test-extraction-result.js',
  'test-import-benchmark.js',
  'test-import-benchmark-cli.js',
  'test-import-benchmark-evaluator.js',
  'test-import-benchmark-formats.js',
  'test-import-benchmark-private.js',
  'test-import-benchmark-ux.js',
  'test-import-bakeoff.js',
  'test-import-bakeoff-cli.js',
  'test-import-bakeoff-corpus.js',
  'test-import-bakeoff-evaluator.js',
  'test-import-corpus.js',
  'test-import-format-corpus.js',
  'test-import-state-migration.js',
  'test-extraction-recovery.js',
  ...
  'test-profile-migration-idempotency.js',
  ...
  'test-library-search-controls.js',
