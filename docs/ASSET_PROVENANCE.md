...
| `public/icon-512.png` | `76991a705bf0ff22e8d879a1737590bfbac06e05e28ce8a9f309eb5fb85f6faf` | Same project-owned Xandrio artwork; introduced by project commit `342628e`. The project owner confirmed ownership and authorized public distribution during release review on 2026-07-15. The Umbrel copy was removed with Umbrel packaging on 2026-08-29. | **Approved by project owner — 2026-07-15** |
...
| `public/downloads/Xandrio-Calibre.zip` | `da7c233b2917dc1c457d5b53de32f807a59a8c3b2b7801ef120560b46a78e613` | Reproducible archive generated only from the repository's MIT-licensed Calibre plugin source, README, import marker, and bundled project `LICENSE`; fixed ZIP timestamps are verified by `test-calibre-plugin-package.js` | **Project-generated MIT code — 2026-08-16** |
