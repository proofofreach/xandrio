...
| Study | Book Guides for admin-attested English nonfiction | Experimental; disabled by default; local Ollama-compatible generation/verifier only; fiction is future scope | Offline 12-work corpus, frozen 200-claim verifier calibration, guide lifecycle/API/UI/browser tests |
