...
| Study | Book Guides for explicitly tagged English nonfiction | Experimental; disabled by default; PPQ.ai ZDR-capable DeepSeek/GLM routes; configuration-time external-processing acknowledgement; on-demand active-voice TTS playlist; fiction is future scope | 12-work corpus, frozen 200-claim verifier calibration, guide lifecycle/API/UI/browser tests |
