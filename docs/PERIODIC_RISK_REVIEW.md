...
| Packaging and recovery | Every release; quarterly restore drill | Docker, FIRST-01/DATA-02 evidence, backup checksum and restore log | Packaging maintainer | Initial review pending |
