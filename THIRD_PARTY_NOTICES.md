...
| @nodable/entities | 2.2.0 | MIT | https://github.com/nodable/val-parsers.git |
...
| brace-expansion | 1.1.13 | MIT | git://github.com/juliangruber/brace-expansion.git |
...
| fast-uri | 3.1.3 | BSD-3-Clause | https://github.com/fastify/fast-uri.git |
| fast-xml-builder | 1.3.0 | MIT | https://github.com/NaturalIntelligence/fast-xml-builder.git |
| fast-xml-parser | 5.10.0 | MIT | https://github.com/NaturalIntelligence/fast-xml-parser.git |
