...
| 2026-09-04 | Prohibited repository-root content searches at the start of a behavior trace. | The second run produced a correct final answer but still spent 106,514 tokens on broad discovery. | Book timeline, Smart Rewind, single-file player, playback session, and playback orchestrator suites passed 138 tests with no failures. | Kept |
