...
function createBookDocument(options = {}) {
  ...
  async function extractChapters(bookPath) {
    if (isXBookPath(bookPath)) {
      ...
      return attachSourceDocument(
        normalizeSequence(splitChapters(xbook.chapters)),
    ...
    const extraction = (async () => {
      ...
      const sourceDocument = chapters?.sourceDocument;
      chapters = attachSourceDocument(
        normalizeSequence(splitChapters(chapters)),
        sourceDocument
      );
