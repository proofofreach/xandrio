...
function createPpqBookGuideProvider({
    ...
    try {
      response = await fetchImpl(`${PPQ_BASE_URL}/chat/completions`, {
        ...
        body: JSON.stringify({
          ...
          max_tokens: purpose === 'composition' ? 12000 : purpose === 'verification' ? 6000 : 1800,
  ...
  return {
    id: 'ppq-ai',
    verificationPolicy: 'ppq-verification-v2-output6000',
    label: 'PPQ.ai',
    external: true,
    authMode: 'api-key',
    models: [
      { id: GEMINI_FLASH_MODEL, label: 'Gemini 3.7 Flash', detail: 'Recommended' },
      { id: DEEPSEEK_FLASH_MODEL, label: 'DeepSeek V4 Flash 0731', detail: '1M context' },
      { id: DEEPSEEK_PRO_MODEL, label: 'DeepSeek V4 Pro 0813', detail: '1M context' },
      { id: GLM_VERIFIER_MODEL, label: 'GLM 5.2', detail: 'Independent verifier' }
    ],
    generate,
    inspect,
