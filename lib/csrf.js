 ...
 * `req.protocol` and `req.host` already honour X-Forwarded-* under Express's
 * `trust proxy`, so a TLS-terminating reverse proxy is handled without the
 * gate having to know about it.
 */
...
module.exports = { createCsrfMiddleware, configuredAllowedOrigins, normalizeOrigin, requestOrigin };
