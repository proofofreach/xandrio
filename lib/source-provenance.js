const SOURCE_RIGHTS_POLICIES = Object.freeze({
  ...
  calibre: Object.freeze({ rightsStatus: 'operator-supplied', requiresOperatorAcknowledgement: false }),
...
function buildSourceProvenance({ provider, acquiredAt, originalFilename, details = {} }) {
  ...
  return {
    ...
    acquiredAt,
    ...((source === 'upload' || source === 'calibre') && originalFilename
      ? { originalFilename: cleanText(originalFilename, 500) }
      : {}),
    ...(itemId ? { itemId } : {}),
    ...(sourceUrl ? { sourceUrl } : {}),
