...
function registerPlaybackRoutes(app, {
  ...
  app.get('/api/audio-hls/:bookId/:chapterIndex/index.m3u8', async (req, res) => {
    try {
  ...
  app.get('/api/audio-hls-segment/:sessionId/:fileName', async (req, res) => {
    try {
  ...
  app.get('/api/audio-timeline/:sessionId', (req, res) => {
