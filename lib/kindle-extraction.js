const { recoverKindleAuthoredChapters } = require('./kindle-authored-chapters');
const os = require('os');
...
async function buildKindleExtractionCandidate(bookPath, sourceLabel, spec, options = {}) {
  ...
  try {
    ...
    const chapters = attachMutationActivations(
      splitOversizedChapters(recoverKindleAuthoredChapters(extracted.chapters)),
